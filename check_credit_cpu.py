...
arquivoOutput = caminhoAbsoluto + 'Check_credit_cpu $DATA$.csv'.replace('$DATA$', date )

with open(arquivoOutput, 'w') as csvfile:
    spamwriter = csv.writer(csvfile, delimiter=',', quoting=csv.QUOTE_MINIMAL)
    spamwriter.writerow(['InstanceType','InstanceId', 'Region', 'Creditos usados', 'Creditos ganhos', 'Porcentagem de uso'])
    for r in res:
       spamwriter.writerow([r['InstanceType'],r['InstanceId'],r['Region'], r['Creditos usados'],r['Creditos ganhos'],r['Porcentagem de uso']])
